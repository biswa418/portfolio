    ...
    <Section id='contact'>
      <Container className='flex justify-between flex-col md:flex-row relative'>
        <Left className='items-end justify-center flex-col'>
          <div className='mx-auto flex flex-col justify-center items-center h-1/3 lg:h1/3 w-2/3 lg:w-1/3 '>
            ...
            <ul className='flex flex-col justify-between w-full '>
              <div className='flex justify-evenly items-center mb-4'>
                <li className='text-xl md:text-3xl mr-2 md:py-4 md:px-4 font-medium z-10 px-2 py-2 flex items-center w-max gap-4 justify-center rounded-full bg-teal-200 ring-2 sm:ring-4 ring-teal-300/30 text-teal-700'>
                  <a href='https://www.github.com/biswa418' target='_blank'>
                    <BsGithub />
                  </a>
                </li>

                <li className='text-xl md:text-3xl mr-2 md:py-4 md:px-4 font-medium z-10 px-2 py-2 flex items-center w-max gap-4 justify-center rounded-full bg-blue-200 ring-2 sm:ring-4 ring-blue-300/30 text-blue-700'>
                  <a href='https://www.linkedin.com/in/biswajeet-sutar' target='_blank'>
                    <BsLinkedin />
                  </a>
                </li>

                <li className='text-xl md:text-3xl mr-2 md:py-4 md:px-4 font-medium z-10 px-2 py-2 flex items-center w-max gap-4 justify-center rounded-full bg-rose-200 ring-2 sm:ring-4 ring-rose-300/30 text-rose-700'>
              ...
              <li>
                <a href='./public/Biswajeet_cv.pdf' draggable='false' className='text-xl mx-auto lg:text-3xl lg:py-3 lg:px-5 font-medium z-10 px-2 py-1 md:my-3 flex items-center w-max gap-4 justify-center rounded-full bg-fuchsia-200 ring-2 sm:ring-4 ring-fuchsia-300/30 text-fuchsia-700' target="_blank" rel="noopener noreferrer" download>
          ...
          <form className='w-10/12 md:w-11/12 min-w-[270px] max-w-screen-lg max-[768px]:flex max-[768px]:flex-col max-[768px]:h-max max-[768px]:gap-2 max-[768px]:px-4 max-[768px]:py-6 gap-8 px-8 py-16 my-6 mx-auto md:mx-0 text-purple-900 bg-purple-200 md:px-12 lg:px-16 rounded-lg ring-4 ring-purple-200/30' action="" method="post">
