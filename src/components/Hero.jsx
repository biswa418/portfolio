    ...
    return (
        <Section id='#'>
            ...
            <Container className='w-4/5 flex justify-between relative items-center max-[768px]:px-5 max-[768px]:w-full max-[768px]:flex-col max-[768px]:items-center max-[768px]:justify-center'>
                <Left className='flex-[2_2_0%] pl-4 flex flex-col justify-center'>

                    <span className='text-5xl max-[768px]:text-2xl max-[768px]:mt-4'>I'm a </span>
                    <div className='text-5xl max-[768px]:text-2xl'>
                        <span className='text-6xl max-[768px]:text-3xl text-[#e57ebd]' ref={el} />
                    </div>
                    <div className='text-2xl max-[768px]:text-lg z-[1] mt-4 max-[768px]:m-0'>
                    ...
                    <button className='absolute cursor-pointer z-10 left-0 right-0 bottom-8 m-auto text-5xl mt-4 animate-bounce text-[#A6176C]' onClick={(e) => {
                        e.preventDefault();
                ...
                <Right className='flex-[3_2_0%] relative flex justify-center max-[768px]:w-[600px]'>
