    ...
    return (
        <nav className='flex justify-center md:w-full z-10'>
            <div className='flex justify-between py-3 items-center w-4/5 max-[768px]:w-full max-[768px]:p-3'>
                <div className='flex items-center cursor-pointer' onClick={() => { e.preventDefault(); window.location.href = '#'; }}>
                    <img src='./images/white-logo.png' className='h-9 max-[768px]:mt-3' alt='logo' />
